...
class ReleaseController {
    ...
    def save() {
        ...
        println params
		//def rtParams1 = [releaseId:1,taskId:1]
	//	def rtInstance = new ReleaseTask(taskType:'email',releaseId:1,taskId:1)
		//println rtParams1
		//println rtInstance.save()
		if (!releaseInstance.save(flush: true)) {
            //forward controller:'ReleaseTask', action:'save', params:params 
			render(view: "create", model: [releaseInstance: releaseInstance])
          	 return
        }
		forward controller:'releaseTask', action:'save', params:[releaseId:1]
